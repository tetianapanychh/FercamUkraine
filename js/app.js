 ...
 */            (function() {
                ...
                Pathformer.prototype.polylineToPath = function(element) {
                    var i, path, newElement = {}, points = element.points.trim().split(" ");
                ...
                Vivus.EASE_OUT_BOUNCE = function(x) {
                    var base = -Math.cos(x * (.5 * Math.PI)) + 1, rate = Math.pow(base, 1.5), rateR = Math.pow(1 - x, 2), progress = -Math.abs(Math.cos(rate * (2.5 * Math.PI))) + 1;
                    ...
                    switch (element.constructor) {
                      ...
                      case window.HTMLObjectElement:
                        ...
                        onLoad = function(e) {
                            ...
                            if (!self.el && e) throw new Error("Vivus [constructor]: object loaded does not contain any SVG"); else if (self.el) {
                ...
                Vivus.prototype.setOptions = function(options) {
                    ...
                    if (options !== void 0 && options.constructor !== Object) throw new Error('Vivus [constructor]: "options" parameter must be an object'); else options = options || {};
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".transport__slider")) new Swiper(".transport__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.5,
        ...
        function swiperSmall() {
            if (document.querySelector(".company__items")) if (window.innerWidth <= 599.98) {
                if (!init) {
                    sliderAbout = new Swiper(".company__items", {
                        modules: [ Navigation ],
                        observer: true,
                        observeParents: true,
                        speed: 800,
